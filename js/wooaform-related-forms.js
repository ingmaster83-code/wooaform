(function () {
  var FORMS = [
    ...
    { s:'gakseo',           ko:'각서 · 위임장',    i:'✍️', c:'contract', url:'forms/gakseo.html',                internal:true  },
    /* ── 업무/비즈니스 ── */
    ...
    { s:'household',        ko:'가계부',            i:'📊', c:'finance',  url:'forms/household.html',             internal:true  },
    /* ── 공공/행정 ── */
    { s:'gov24',            ko:'정부24 서식 모음',  i:'🏛️', c:'public',  url:'forms/gov24.html',                 internal:true  },
    { s:'juminbon',         ko:'주민등록등본',      i:'🪪', c:'public',   url:'forms/juminbon.html',              internal:true  },
    { s:'family-cert',      ko:'가족관계증명서',    i:'👨‍👩‍👧', c:'public', url:'forms/family-cert.html',          internal:true  },
  ];
